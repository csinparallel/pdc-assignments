...
int main()
{
    ...
    char test0[9] = {0};
    status = findPinFromHash(hash[0], test0, 1);
    ...
    char test1[9] = {0};
    status = findPinFromHash(hash[1], test1, 1);
    ...
    char test2[9] = {0};
    status = findPinFromHash(hash[2], test2, 1);
    ...
    char test3[9] = {0};
    status = findPinFromHash(hash[3], test3, 1);
    ...
    char test4[9] = {0};
    status = findPinFromHash(hash[4], test4, 1);
