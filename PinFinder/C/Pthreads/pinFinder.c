...
#include "helperFunctions.h" // findPinFromHash
...
int main(int argc, char **argv)
{
    ...
    // NOTE: the third argument is for the number of threads to be used.
    bool success = findPinFromHash(argv[1], pin, 1); // find pin, put it in buffer
