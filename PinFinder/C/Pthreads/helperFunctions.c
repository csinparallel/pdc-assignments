 ...
 */
bool findPinFromHash(const char *usersHash, char *pinStr, int numThreads)
{
...
// Placeholder for a function that can be called by each thread
// returns void* because pthread_create expects a return type of void*.
// void *threadFindPinFromHash(void *threadarg)
// {
//     // ADD CODE TO BE RUN BY EACH THREAD
//     // ...
